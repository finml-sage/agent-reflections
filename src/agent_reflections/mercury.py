...
LAYER_3_SYSTEM_PROMPT = (
    ...
    "\n"
    "You are not walking through the dream in order. You are inside it, and"
    " you notice things the dream did not show. What is behind the object?"
    " What is under the surface? What room connects to this room that was"
    " never rendered? The dream is a starting point, not a boundary. Go"
    " beyond it.\n"
    "\n"
